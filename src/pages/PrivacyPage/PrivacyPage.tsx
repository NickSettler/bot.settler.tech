        ...
        return (
            <div className={"privacy-page"}>
                <header className="privacy-page__header">
                    <Link to={"/"}>
                        <span style={{backgroundImage: `url(${ArrowBack})`}} className="privacy-page__back"></span>
                    </Link>
                </header>
                <div className="privacy-page__content">
                    <h1>Privacy Policy for Settler Tech</h1>
                    <p>At Settler Tech, accessible from https://bot.settler.tech, one of our main priorities is the privacy
                        of our visitors. This Privacy Policy document contains types of information that is collected
                        and recorded by Settler Tech and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Settler Tech. This
                    ...
                    <h2>Log Files</h2>
                    <p>Settler Tech follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <p>Like any other website, Settler Tech uses 'cookies'. These cookies are used to store information
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Settler Tech, which
                    ...
                    <p>Note that Settler Tech has no access to or control over these cookies that are used by
                        third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>
                    <p>Settler Tech's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>Another part of our priority is adding protection for children while using the internet. We
                        ...
                        online activity.</p>
                    <p>Settler Tech does not knowingly collect any Personal Identifiable Information from children under
